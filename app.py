...
# Sidebar
with st.sidebar:
    # Add Mentat icon with reduced size and theme adaptation
    st.markdown("""
    <style>
    .mentat-logo {
        filter: invert(1);
    ...
    st.markdown('<img src="icons/Mentat_Updated.svg" width="300" class="mentat-logo">', unsafe_allow_html=True)
    
    # Add mentat words with blue color
    st.markdown("""
    <style>
    .mentat-words {
